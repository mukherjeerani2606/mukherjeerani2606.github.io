  ...
  langBtn.addEventListener("click", ()=>{
    ...
    if(aboutText){
      aboutText.textContent = isEnglish 
        ? `I am Rani Mukherjee, an engineering student, but I love writing beyond my profession.  
...
If my writing touches some hidden feeling in your heart, my effort is worthwhile.`
        : `আমি রাণী মুখার্জী, এক ইঞ্জিনিয়ারিং ছাত্রী, তবে পেশার বাইরের জগতটায় আমি লিখতে ভালোবাসি।  
